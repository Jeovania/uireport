...
class Admin::QuestionsControllerTest < ActionController::TestCase
  ...
  test "should create admin_question" do
    assert_difference('Admin::Question.count') do
      post :create, admin_question: { description: @admin_question.description, heuristic_id: @admin_question.heuristic_id, name: @admin_question.name }
    end
  ...
  test "should update admin_question" do
    patch :update, id: @admin_question, admin_question: { description: @admin_question.description, heuristic_id: @admin_question.heuristic_id, name: @admin_question.name }
    assert_redirected_to admin_question_path(assigns(:admin_question))
  end
